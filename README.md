...
- 🔭 I build full-stack mobile apps with **Flutter, Firebase, and Node.js**
- 🧱 I care about structure — clean, readable code over messy shortcuts
- 📱 State management with **Bloc, GetX, and Provider**
- 🔥 Comfortable across the stack: backend logic + API integrations
- 🎯 Goal: ship scalable apps, grow independently, and keep sharpening the engineering
...
<p>
  ...
  <img src="https://img.shields.io/badge/Bloc-1877F2?style=for-the-badge&logo=flutter&logoColor=white"/>
  <img src="https://img.shields.io/badge/GetX-8A2BE2?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Provider-4CAF50?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Clean%20Architecture-607D8B?style=for-the-badge"/>
</p>
...
|---|---|---|
| **[Tutor Connect System](https://github.com/alizasaeed02/tutor-connect-system-web-project)** | Full-stack education platform with role-based auth and admin-level controls | PHP · MySQL · JS |
| **[Weather App](https://github.com/alizasaeed02/Weather_App)** | Forecasting app pulling live API data, with Google Maps location | Flutter · REST API |
